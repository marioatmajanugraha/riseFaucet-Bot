...
export declare class AntiCaptcha {
     ...
     * @memberof AntiCaptcha
     */
    createTaskRecaptchaV2Proxyless(websiteURL: string, websiteKey: string, languagePool?: string): Promise<number>;
    /**
     *
     * @param {string} websiteURL - The URL where the captcha is defined.
     * @param {string} websiteKey - The value of the "data-site-key" attribute.
     ...
     * @memberof AntiCaptcha
     */
    createTaskRecaptchaV3Proxyless(websiteURL: string, websiteKey: string, minScore: number, pageAction: string, languagePool?: string, isEnterprise?: boolean): Promise<number>;
    /**
