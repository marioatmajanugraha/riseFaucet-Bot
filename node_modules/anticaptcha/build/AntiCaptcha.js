...
class AntiCaptcha {
     ...
     * @memberof AntiCaptcha
     */
    createTaskRecaptchaV2Proxyless(websiteURL, websiteKey, languagePool = "en") {
        return __awaiter(this, void 0, void 0, function* () {
            const response = (yield this.api.post("createTask", {
                languagePool,
                task: {
                    type: enum_1.TaskTypes.RECAPTCHAV2_PROXYLESS,
                    websiteKey,
                    websiteURL,
                    websiteSToken: null,
     ...
     * @memberof AntiCaptcha
     */
    createTaskRecaptchaV3Proxyless(websiteURL, websiteKey, minScore, pageAction, languagePool = "en", isEnterprise = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = (yield this.api.post("createTask", {
                languagePool,
                task: {
